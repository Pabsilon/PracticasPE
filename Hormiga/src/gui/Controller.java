...
public class Controller {
	...
	{		
		...
		Algoritmo algoritmo = new Algoritmo(Integer.parseInt(poblacion), Integer.parseInt(generaciones), Long.parseLong(semilla), new ACruce_Intercambio(), agm,ags,agb, bloating, Float.parseFloat(probCruece), Float.parseFloat(probMutacion),elitismo);
		...
		//TODO quitar esto
		System.out.println(resultado.getAptitud() + " " + resultado.getFenotipo());
